        ...
        <form action="{{ route('jobs.index') }}" method="GET">
            <div class="mb-4 grid grid-cols-2 gap-4">
                <div>
                    ...
                    <x-text-input name="search" value="{{ request('search') }}" placeholder="Search by title or description" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <label for="experience" class="mb-1 flex items-center">
                        <input type="radio" name="experience" value="entry" value="" @checked('entry' === request('experience')) />
